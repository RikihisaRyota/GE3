...
RWStructuredBuffer<GPUParticleShaderStructs::FieldForGPU> addField : register(u0);
RWStructuredBuffer<GPUParticleShaderStructs::FieldForGPU> origalField : register(u1);
