...
float PointLightBlinnPhongReflection(float3 normal, float3 cameraPos, float3 worldPos, float3 pointLightPos, float shininess)
{
    float3 toEye = normalize(cameraPos - worldPos);
...
float PointLightPhongReflection(float3 normal, float3 cameraPos, float3 worldPos, float3 pointLightPos, float shininess)
{
